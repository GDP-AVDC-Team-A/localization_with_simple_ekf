#include "../include/aerostackRobotLocalization.h"
...
AerostackRobotLocalizationModule::AerostackRobotLocalizationModule()
{
    return;
}
...
void AerostackRobotLocalizationModule::readParameters()
{
    //Config file
...
bool AerostackRobotLocalizationModule::init(std::string configFile)
{
...
bool AerostackRobotLocalizationModule::readConfigs(std::string configFile)
{
...
void AerostackRobotLocalizationModule::open(ros::NodeHandle & nIn)
{
    //read the parameters from the launch file
    readParameters();
    //Init
    stackPath = "/home/pablo/workspace/ros/aerostack_catkin_ws/src/aerostack_stack/projects_test/bebop/";
    if(!init(stackPath+"configs/drone4"+"/"+configFile))
    {
    ...
    //// TOPICS
    //Subscribers
    droneImuSub                 = n.subscribe("imu", 1, &AerostackRobotLocalizationModule::droneImuCallback, this);
    droneCommandPitchRollSub    = n.subscribe("command/pitch_roll",1,&AerostackRobotLocalizationModule::droneCommandPitchRollCallback, this);
    droneCommandDaltitudeSub    = n.subscribe("command/dAltitude",1,&AerostackRobotLocalizationModule::droneCommandDaltitudeCallback, this);
    droneCommandDyawSub         = n.subscribe("command/dYaw",1, &AerostackRobotLocalizationModule::droneCommandDyawCallback, this);
    droneAltitudeSub            = n.subscribe("altitude",1,&AerostackRobotLocalizationModule::droneAltitudeCallback, this);
    droneSpeedsSub              = n.subscribe("ground_speed",1,&AerostackRobotLocalizationModule::droneSpeedsCallback, this);
    droneOdomFilteredSub        = n.subscribe("odometry/filtered",1,&AerostackRobotLocalizationModule::droneOdometryFilteredCallback, this);
    droneRotationAnglesSub      = n.subscribe("rotation_angles",1,&AerostackRobotLocalizationModule::droneRotationAnglesCallback, this);
    dronePnPPoseSub             = n.subscribe("vb_estimated_pose/rpnp_pose",1,&AerostackRobotLocalizationModule::dronePnPPoseCallback, this);
    droneGPSDataSub             = n.subscribe("mavros/global_position/raw/fix",1,&AerostackRobotLocalizationModule::droneGPSDataCallback, this);
    droneHectorSlamdPoseSub     = n.subscribe("poseupdate",1,&AerostackRobotLocalizationModule::droneHectorSlamPoseCallback, this);
    mavrosLocalSpeedsSubsriber  = n.subscribe("/gazebo/model_states",1, &AerostackRobotLocalizationModule::localSpeedsCallbackGazebo, this);
    droneLaserScanPoseSub       = n.subscribe("lb_estimated_pose/door_pose", 1, &AerostackRobotLocalizationModule::droneLaserScanPoseCallback, this);
    droneLaserScanWindowPoseSub = n.subscribe("lb_estimated_pose/window_pose", 1, &AerostackRobotLocalizationModule::droneLaserScanWindowPoseCallback, this);
    droneSlamDunkPoseSub        = n.subscribe("/pose", 1, &AerostackRobotLocalizationModule::droneSlamDunkPoseCallback, this);
    droneVOSematicSLAMSub       = n.subscribe("/final_pose",1, &AerostackRobotLocalizationModule::droneVOSemanticSLAMPoseCallback, this);
    ...
    self_localization_pose_pub = n.advertise<geometry_msgs::PoseStamped>("self_localization/pose",1,true);
    self_localization_twist_pub = n.advertise<geometry_msgs::TwistStamped>("self_localization/speed",1,true);
...
void AerostackRobotLocalizationModule::close()
{
    //Do stuff
...
bool AerostackRobotLocalizationModule::resetValues()
{
    //Reseting the ekf
...
bool AerostackRobotLocalizationModule::startVal()
{
    //Reseting the ekf
...
bool AerostackRobotLocalizationModule::stopVal()
{
    //Do stuff
...
bool AerostackRobotLocalizationModule::run()
{
    return true;
}

void AerostackRobotLocalizationModule::droneImuCallback(const sensor_msgs::Imu &msg)
{
...
void AerostackRobotLocalizationModule::droneRotationAnglesCallback(const geometry_msgs::Vector3Stamped &msg)
{
...
void AerostackRobotLocalizationModule::droneCommandPitchRollCallback(const droneMsgsROS::dronePitchRollCmd &msg)
{
...
void AerostackRobotLocalizationModule::droneCommandDaltitudeCallback(const droneMsgsROS::droneDAltitudeCmd &msg)
{
...
void AerostackRobotLocalizationModule::droneCommandDyawCallback(const droneMsgsROS::droneDYawCmd &msg)
{
...
void AerostackRobotLocalizationModule::droneAltitudeCallback(const droneMsgsROS::droneAltitude &msg)
{
...
void AerostackRobotLocalizationModule::droneSpeedsCallback(const droneMsgsROS::vector2Stamped &msg)
{
...
void AerostackRobotLocalizationModule::dronePnPPoseCallback(const geometry_msgs::Pose &msg)
{
...
void AerostackRobotLocalizationModule::droneGPSDataCallback(const sensor_msgs::NavSatFix &msg)
{
...
void AerostackRobotLocalizationModule::localSpeedsCallbackGazebo(const gazebo_msgs::ModelStatesConstPtr &msg){
...
void AerostackRobotLocalizationModule::droneHectorSlamPoseCallback(const geometry_msgs::PoseWithCovarianceStamped &msg)
{
...
void AerostackRobotLocalizationModule::droneSlamDunkPoseCallback(const geometry_msgs::PoseStamped &msg)
{
...
void AerostackRobotLocalizationModule::droneVOSemanticSLAMPoseCallback(const geometry_msgs::PoseStamped& msg)
{
...
void AerostackRobotLocalizationModule::droneLaserScanPoseCallback(const nav_msgs::Odometry &msg)
{
...
void AerostackRobotLocalizationModule::droneLaserScanWindowPoseCallback(const nav_msgs::Odometry &msg)
{
...
void AerostackRobotLocalizationModule::droneOdometryFilteredCallback(const nav_msgs::Odometry &msg)
{
    //-----------------------------------------------------------------------------------------------------------
...
void AerostackRobotLocalizationModule::PublishImuData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishRotationAnglesData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishOdomData()
{
...
void AerostackRobotLocalizationModule::PublishAltitudeData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishAltitudeGTData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishSpeedsData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishPnPData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishGPSData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishHectorSlamData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishSlamdunkData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishVOSemanticSLAMPoseData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishLaserScanPoseData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishLaserScanWindowPoseData()
{
    if(moduleStarted == true)
...
void AerostackRobotLocalizationModule::PublishEstimatedData()
{
    if(moduleStarted == true)
    {
...
void AerostackRobotLocalizationModule::PublishBebopIMUData()
{
    if(moduleStarted == true)
    {
...
void AerostackRobotLocalizationModule::PublishBebopOdomData()
{
    if(moduleStarted == true)
    {
